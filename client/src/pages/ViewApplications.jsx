                    ...
                    <tbody>
                        {viewApplicationsPageData.map((applicant, index) => (
                            <tr key={index} className='text-gray-700'>
                                ...
                                <td className='py-2 px-4 border-b text-center flex items-center max-lg:flex-col'>
                                ...
                                <td className='py-2 px-4 border-b'>
                                    <a href="" target='_blank' className='bg-blue-100 text-blue-500 px-3 py-1 rounded inline-flex gap-2 items-center'>
                                        Resume
